...
from fake_news_detection.fake_news_detection import fake_news_detection as fn
...
if __name__ == "__main__":
    ...
    # tc(models=['nmf'], target_metric='coherence', reduction=None, options='default', vectorizer_type='tfidf', visualizations=False)
