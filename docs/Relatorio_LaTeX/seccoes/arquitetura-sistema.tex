...
As saídas dos quatro modelos especialistas (probabilidades, classes e \textit{scores}) são concatenadas num vetor de \textit{meta-features}. Este vetor serve de entrada para o Meta-Classificador (treinado no \textit{dataset} FakeNewsNet). 
