...
Os resultados, apresentados na Tabela \ref{tab:stance-results}, revelam uma grande diferença de desempenho. A SVM obteve um F1-Score de 0.8430, demonstrando uma capacidade muito superior para lidar com a alta dimensionalidade dos vetores de texto gerados pelos \textit{n-grams}, enquanto o \textit{Random Forest} revelou-se ineficaz para este nível de complexidade vetorial.
